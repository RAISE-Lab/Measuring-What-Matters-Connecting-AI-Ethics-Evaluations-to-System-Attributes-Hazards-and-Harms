...
def display_click_data(clickData):
    if clickData is None:
        return html.Div([
            ...
            html.Ul([
                html.Li("Please allow a few seconds for the diagram to run."),
                html.Li("First, select a principle, followed by the component of the ML system that you are interested in exploring, and the primary harm."),
    ...
    if clicked_label in grouped_df_process['Measure'].values:
        ...
        return html.Div([
            ...
            html.Br(), html.B("Hazard: "), html.Span(row['Hazard']),
            html.Br(), html.B("Secondary Harm: "), html.Span(row['Secondary Harm']),
            html.Br(), html.B("Attribute: "), html.Span(row['Attribute']),
            html.Br(), html.B("Type of Assessment: "), html.Span(row['Type of Assessment']),
